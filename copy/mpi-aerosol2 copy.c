...
int main(int argc, char* argv[]) {
  ...
  //==================================================
  //==================================================
  // WE SHOULD BE ABLE TO PARALLELISE THIS
  //==================================================
  //==================================================
  totalMass = 0.0;
  for (i=0; i<num; i++) {
  ...
  */
  ...
  //==================================================
  // WE SHOULD BE ABLE TO PARALLELISE THIS
  // Can be tricky depending on the variable used
  //==================================================
  //==================================================
...
double calc_system_energy(double mass, double *vx, double *vy, double *vz, int num) {
  ...
  int i;
  double totalEnergy = 0.0, localEnergy = 0.0, systemEnergy;
  ...
  for (i=startIndex; i<endIndex; i++) {
      localEnergy += vx[i]*vx[i] + vy[i]*vy[i] + vz[i]*vz[i];
  }
